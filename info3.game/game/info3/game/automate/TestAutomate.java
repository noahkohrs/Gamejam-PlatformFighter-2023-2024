...
public class TestAutomate {
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("\nEtat initial ->"+parser.autos.get(0).src.name+" avec e.x="+parser.autos.get(0).e.x);
        parser.autos.get(0).step();
        System.out.println("Etat apres step ->"+parser.autos.get(0).src.name+" avec e.x="+parser.autos.get(0).e.x);
        parser.autos.get(0).step();
        System.out.println("Etat apres step ->"+parser.autos.get(0).src.name+" avec e.x="+parser.autos.get(0).e.x);
        parser.autos.get(0).step();
        System.out.println("Etat apres step ->"+parser.autos.get(0).src.name+" avec e.x="+parser.autos.get(0).e.x);
